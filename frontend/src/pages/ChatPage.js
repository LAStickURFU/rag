...
function ChatPage() {
  ...
  return (
    <Container maxWidth="xl" sx={{ height: '100vh', pt: 2, pb: 2 }}>
      <Grid container spacing={2} sx={{ height: '100%' }}>
        {/* Левая часть - чат */}
        <Grid item xs={12} md={8} lg={7} sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
          <Paper
            ref={chatPaperRef}
            sx={{
              flex: 1,
              mb: 2,
              p: 0, // убираем паддинг, чтобы шапка была на всю ширину
              overflowY: 'auto',
              display: 'flex',
        ...
        <Grid item xs={12} md={4} lg={5} sx={{ height: '100%' }}>
